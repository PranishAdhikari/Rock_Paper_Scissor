...
public class RockPaperScissorsFrame extends JFrame {
    ...
    private void createBtnPnl() {
        ...
        paperBtn.setIcon((new ImageIcon(new ImageIcon("C:\\Users\\pranish\\Downloads\\Rock_Paper_Scissor\\src\\paper.jpg").getImage().getScaledInstance(200, 200, Image.SCALE_DEFAULT))));
        ...
        rockBtn.setIcon((new ImageIcon(new ImageIcon("C:\\Users\\pranish\\Downloads\\Rock_Paper_Scissor\\src\\rock.jpg").getImage().getScaledInstance(200, 200, Image.SCALE_DEFAULT))));
        ...
        scissorBtn.setIcon((new ImageIcon(new ImageIcon("C:\\Users\\pranish\\Downloads\\Rock_Paper_Scissor\\src\\sisccor.jpg").getImage().getScaledInstance(200, 200, Image.SCALE_DEFAULT))));
        ...
        quitBtn.setIcon(new ImageIcon(new ImageIcon("C:\\Users\\pranish\\Downloads\\Rock_Paper_Scissor\\src\\quit.jpg").getImage().getScaledInstance(200, 200, Image.SCALE_DEFAULT)));
